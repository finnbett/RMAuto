...
export function Contact () {
    ...
    <>
        <h1>Contact</h1>
        <h2>Phone</h2>
        <FontAwesomeIcon icon={faPhone} className="icon"></FontAwesomeIcon><span>022 192 9380</span>
        <h2>Facebook</h2>
                <FontAwesomeIcon icon={faFacebook} className="icon"></FontAwesomeIcon>
        <h2>Email</h2>
                <FontAwesomeIcon icon={faEnvelope} className="icon"></FontAwesomeIcon><span>rikomahe18@gmail.com</span>
        <h2>Opening Hours</h2>
        <h2>Address</h2>
